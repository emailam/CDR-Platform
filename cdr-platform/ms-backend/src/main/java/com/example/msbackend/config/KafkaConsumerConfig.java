...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CDR> consumerFactory() {
        JsonDeserializer<CDR> deserializer = new JsonDeserializer<>(CDR.class, false); // false disables type headers use
        deserializer.setRemoveTypeHeaders(false);
        deserializer.addTrustedPackages("com.example.*"); // restrict to your trusted packages
        deserializer.setUseTypeMapperForKey(false); // optional
